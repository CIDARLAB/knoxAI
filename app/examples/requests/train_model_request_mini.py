## - Example JSON Input to Train Model - ##
config = {
    "data": {

        # Training data examples, List of dictionaries with design and score keys
        "training_data": [ # (Required)
            {"design": ["A", "B", "C", "D", "E"], "score": 1.0, "class": 1}, 
            {"design": ["F", "G", "H", "I", "J"], "score": 0.8, "class": 0}, # "design" is a list of part IDs (str), "score" is the target value (float)
            {"design": ["K", "L", "M", "N", "O"], "score": 0.6, "class": 0}
        ],
        ...
        "interaction_library": { # (Optional, required for interaction edges)
            "A": {"B": {"type": "yes", "only_adjacent": "True", "features": [1.0, 2.5]}, "C": {"type": "no", "only_adjacent": "False", "features": [1.0, 2.5]}},
            "E": {"A": {"type": "yes", "only_adjacent": "True", "features": [0.1]}, "C": {"type": "no", "only_adjacent": "False", "features": [0.2]},"H": {"type": "yes", "only_adjacent": "True", "features": [0.3]},"E": {"type": "yes", "only_adjacent": "True", "features": [0.4]}},
            "I": {"L": {"type": "yes", "only_adjacent": "True", "features": [0.1]}, "B": {"type": "yes", "only_adjacent": "True", "features": [0.2]},"J": {"type": "no", "only_adjacent": "False", "features": [0.3]},"N": {"type": "yes", "only_adjacent": "True", "features": [0.4]}},
            "O": {"A": {"type": "no", "only_adjacent": "False", "features": [0.1]}, "K": {"type": "yes", "only_adjacent": "True", "features": [0.2]},"D": {"type": "yes", "only_adjacent": "True", "features": [0.3]}}
        },
